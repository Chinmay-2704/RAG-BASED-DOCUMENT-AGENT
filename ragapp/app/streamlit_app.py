...
st.markdown(
    ...
    .trace-step { background:#f3f4f6; padding:0.6rem 0.8rem; border-left:3px solid #4f46e5;
                  border-radius:4px; margin-bottom:0.4rem; font-size:0.9rem; }
    .source-card { background:#fafafa; padding:0.6rem; border:1px solid #e5e7eb;
